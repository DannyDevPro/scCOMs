    ...
    constructor(runtime) {
        ...
        this._formatMessage = runtime.getFormatMessage({
            'zh-cn': {
                ...
                'AusCOM.socket_create': 'sock.创建[yi]方式[method]并返回id 备注[remarks]',
                'AusCOM.socket_recv': 'sock.收到数据id [id]',
                'AusCOM.socket_send': 'sock.发送数据id [id]数据[TEXT]',
                'AusCOM.socket_conclose': 'sock.连接关闭id[id]',
            ...
            en: {
                ...
                'AusCOM. socket_ sreate ': 'sock. Create [yi] method [method] and return ID,remarks[remarks]',
